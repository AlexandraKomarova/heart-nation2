...
//   try {
//     const options = {
//       uri: `https://api.githup.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&client_id=${config.get("githubClientId")}&client_secret=${config.get("githubSecret")}`,
//       method: "GET",
...
//   try {
//     const uri = encodeURI(
//       `https://api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&client_id=${config.get("githubClientID")}`
//     );
//     const headers = {
//       'user-agent': 'node.js',
